...
public class TrainersControllerTest {
    ...
    public void createTrainer() throws Exception {
        mockMvc.perform( MockMvcRequestBuilders
                .post("/trainers")
                .content(asJsonString(new Trainers("Мамедова Лейла Али-агаевна", "1234567890", "1234567890", "blah-blah")))
    ...
    public void updateTrainer() throws Exception
    {
        mockMvc.perform( MockMvcRequestBuilders
                ...
                .accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(MockMvcResultMatchers.jsonPath("$.name").value("Мамедова Лейла Али-агаевна"))
